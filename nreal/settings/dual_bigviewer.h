...
SetKey(
    ...
    "globals.broadcastViewerAspectRatio", "script.defaultViewerAspectRatio",
    "globals.cacheMode", "2",
    "globals.consoleLineLength", "120",
    "globals.displayThumbnails", "1",
    "globals.enhancedNodeView", "1",
    ...
    "globals.noodleStipple8", "858993459",
    "globals.noodleTension", "0.5",
    ...
    "globals.renderModeTog.cycle", "2,0,0,1",
    ...
    "mainWin.tabChild15", "2.Node_View",
    ...
    "spawnedViewer0_h", "1000",
    "spawnedViewer0_w", "1274",
    "spawnedViewer0_x", "1283",
    "spawnedViewer0_y", "5",
    "spawnedViewerCount", "1",
    "timeView.ctrls.selGroup", "0",
    "timeView.list.open.IMult1.cycle", "-2,-2,0",
    "timeView.list.open.Over1.cycle", "-2,-2,0",
    "timeView.list.open.RGrad1.cycle", "-2,-2,0",
    "timeView.list.open.Screen1.cycle", "-2,-2,0",
    "timeView.list.open.background.cycle", "-2,-2,0",
    "timeView.list.open.lighting.cycle", "-2,-2,0",
    "timeView.list.open.orchid.cycle", "-2,-2,0",
    "timeView.list.open.orchid_Over_table.cycle", "-2,-2,0",
    "timeView.list.open.shadows.cycle", "-2,-2,0",
    "timeView.list.open.table.cycle", "-2,-2,0",
    ...
    "vDesk.0.dodNodeSerial", "SetDOD(Select1, 0, 660, 0, 170);",
    "vDesk.0.dodToggle", "0",
    "vDesk.0.g", "1",
    "vDesk.0.h", "617",
    "vDesk.0.i", "0",
