...
Some reminders:
  - See the enable_open_in_editor option, C-X C-E or 'v' in Vi mode.
  - `ptipython` exists for wrapping ipython in ptpython!
  - Meta-! or just ! in Vi mode gives a shell command prompt.
"""
...
def configure(repl):
    ...
    @repl.add_key_binding(Keys.ControlX, Keys.ControlB)
    def _(event):
